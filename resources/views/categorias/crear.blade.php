<x-app-layout>
    <header>
        <div class="mx-auto max-w-7x1 px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3x1 font-bold tracking-tight text-blue-900">Crear una nueva categoria</h1>
        </div>
    </header>
    <!-- component -->
        ...
        <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
            <div class='max-w-md mx-auto space-y-6'>
                ...
                <form action="{{route('categorias.store')}}" method="POST">
                    @csrf
                    <h2 class="text-2xl font-bold ">Nueva categoria</h2>
                    <p class="my-4 opacity-70">Llene los campos para crear una nueva categoria</p>
                    <hr class="my-6">
